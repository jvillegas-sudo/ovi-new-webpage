...
const PRODUCTS: Product[] = [
  {
    ...
    summary:
      "Formulación enzimática avanzada para desengrase industrial intensivo. Degrada contaminantes orgánicos en profundidad sin atacar superficies metálicas ni dejar residuos tóxicos.",
    highlights: [
      "100% biodegradable, libre de fosfatos",
      "pH neutro — compatible con metales, plásticos y goma",
      "Acción enzimática activa hasta 72 h post-aplicación",
      "Concentración ajustable 1:10 a 1:50",
    ],
    applications: ["Manufactura", "Metalmecánica", "Plantas de alimentos"],
    storeSlug: "ovi-bioclean-pro",
  ...
  },
  {
    ...
    badge: "Alta Potencia",
    summary:
      "Desengrasante de alto rendimiento para maquinaria, equipos y líneas de producción. Actúa sobre grasas minerales, aceites de corte y residuos de proceso con mínimo tiempo de contacto.",
    highlights: [
      ...
      "Sin límite de aplicación en ambientes ventilados",
    ],
    applications: ["Industria pesada", "Energía", "Transporte"],
    accentColor: "var(--color-brand-primary)",
    accentBg: "rgba(0,196,255,0.08)",
    accentBorder: "rgba(0,196,255,0.25)",
  },
  {
    ...
    badge: "Química Verde",
    summary:
      "Solución biodegradable para tratamiento y neutralización de contaminantes en superficies y sustratos industriales. Ideal para operaciones con estrictos protocolos ambientales.",
    highlights: [
    ...
    applications: ["Institucional", "Hospitalario", "Corporativo"],
  ...
  },
  {
    ...
    applications: ["Construcción", "Edificaciones", "Infraestructura"],
  ...
  },
  {
    ...
    summary:
      "Producto especializado para el lavado de vehículos de carga y flota industrial. Elimina grasa de caminos, hollín y contaminantes adheridos sin dañar pinturas ni sellos.",
    highlights: [
    ...
    applications: ["Flota pesada", "Logística", "Transporte público"],
  ...
  },
  {
    ...
    summary:
      "Barrera protectora post-limpieza para superficies de acero inoxidable, aluminio anodizado y recubrimientos electrostáticos. Extiende el ciclo de limpieza y reduce la adherencia de contaminantes.",
    highlights: [
      "Capa protectora activa por 30 días en interior",
      "Repela agua, aceite y polvo fino en superficie",
      "Aplicación con paño — sin equipos especiales",
      "No altera coeficiente de fricción en pisos",
    ],
    applications: ["Manufactura de alimentos", "Hospitalario", "Farmacéutico"],
    storeSlug: "ovi-surface-guard-x9",
    accentColor: "var(--color-brand-accent)",
    accentBg: "rgba(0,255,133,0.07)",
    accentBorder: "rgba(0,255,133,0.2)",
  },
